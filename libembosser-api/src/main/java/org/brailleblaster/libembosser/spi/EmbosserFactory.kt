...
interface EmbosserFactory {
     ...
     */
    @Deprecated("Use localisation within the embosser drivers.", ReplaceWith("embossers"))
    fun getEmbossers(locale: Locale?): List<Embosser?> {
        return embossers
    }
}