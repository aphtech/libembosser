...
public class GenericTextDocumentHandlerTest {
	...
	public Iterator<Object[]> handlerProvider() {
		...
		data.add(new Object[] {new GenericTextDocumentHandler.Builder().build(), minimalDocumentInput, new byte[] {'\f'}});
		data.add(new Object[] {new GenericTextDocumentHandler.Builder().setLinesPerPage(30).build(), minimalDocumentInput, new byte[] {'\f'}});
		data.add(new Object[] {new GenericTextDocumentHandler.Builder().padWithBlankLines(false).build(), minimalDocumentInput, new byte[] {'\f'}});
		data.add(new Object[] {new GenericTextDocumentHandler.Builder().padWithBlankLines(false).setLinesPerPage(30).build(), minimalDocumentInput, new byte[] {'\f'}});
		data.add(new Object[] {new GenericTextDocumentHandler.Builder().padWithBlankLines(true).build(), minimalDocumentInput, Strings.repeat("\r\n", 24).concat("\f").getBytes(Charsets.US_ASCII)});
		data.add(new Object[] {new GenericTextDocumentHandler.Builder().padWithBlankLines(true).setLinesPerPage(30).build(), minimalDocumentInput, Strings.repeat("\r\n", 29).concat("\f").getBytes(Charsets.US_ASCII)});
		...
		data.add(new Object[] {new GenericTextDocumentHandler.Builder().setLinesPerPage(28).build(), basicDocumentInput, basicDocumentOutputString.concat("\f").getBytes(Charsets.US_ASCII)});
		
		data.add(new Object[] {new GenericTextDocumentHandler.Builder().padWithBlankLines(true).build(), basicDocumentInput, paddedBasicDocumentOutput});
		data.add(new Object[] {new GenericTextDocumentHandler.Builder().padWithBlankLines(true).build(), basicCapsDocumentInput, paddedBasicDocumentOutput});
		data.add(new Object[] {new GenericTextDocumentHandler.Builder().padWithBlankLines(true).build(), basicUnicodeDocumentInput, paddedBasicDocumentOutput});
		data.add(new Object[] {new GenericTextDocumentHandler.Builder().padWithBlankLines(true).setLinesPerPage(28).build(), basicDocumentInput, basicDocumentOutputString.concat(Strings.repeat("\r\n", 27)).concat("\f").getBytes(Charsets.US_ASCII)});
		...
		data.add(new Object[] {new GenericTextDocumentHandler.Builder().padWithBlankLines(true).build(), multiLineDocumentInput, String.join("\r\n", multiLineDocumentOutputString).concat(Strings.repeat("\r\n", 22)).concat("\f").getBytes(Charsets.US_ASCII)});
		data.add(new Object[] {new GenericTextDocumentHandler.Builder().padWithBlankLines(true).setLinesPerPage(30).build(), multiLineDocumentInput, String.join("\r\n", multiLineDocumentOutputString).concat(Strings.repeat("\r\n", 27)).concat("\f").getBytes(Charsets.US_ASCII)});
		...
		data.add(new Object[] {new GenericTextDocumentHandler.Builder().padWithBlankLines(true).setLinesPerPage(3).build(), multiLineDocumentInput, String.join("\r\n", multiLineDocumentOutputString).concat("\f").getBytes(Charsets.US_ASCII)});
		...
		data.add(new Object[] {new GenericTextDocumentHandler.Builder().setCellsPerLine(6).build(), multiLineDocumentInput, String.join("\r\n", Arrays.stream(multiLineDocumentOutputString).map(s -> s.substring(0, Math.min(s.length(), 6))).collect(Collectors.toUnmodifiableList())).concat("\f").getBytes(Charsets.US_ASCII)});
		...
		data.add(new Object[] {new GenericTextDocumentHandler.Builder().build(), multiPageDocumentInput, String.join("\f", multiPageDocumentOutputStrings).concat("\f").getBytes(Charsets.US_ASCII)});
		data.add(new Object[] {new GenericTextDocumentHandler.Builder().setLinesPerPage(30).build(), multiPageDocumentInput, String.join("\f", multiPageDocumentOutputStrings).concat("\f").getBytes(Charsets.US_ASCII)});
		data.add(new Object[] {new GenericTextDocumentHandler.Builder().padWithBlankLines(true).build(), multiPageDocumentInput, String.join("\f", Arrays.stream(multiPageDocumentOutputStrings).map(s -> s.concat(Strings.repeat("\r\n", 24))).collect(Collectors.toList())).concat("\f").getBytes(Charsets.US_ASCII)});
		data.add(new Object[] {new GenericTextDocumentHandler.Builder().padWithBlankLines(true).setLinesPerPage(30).build(), multiPageDocumentInput, String.join("\f", Arrays.stream(multiPageDocumentOutputStrings).map(s -> s.concat(Strings.repeat("\r\n", 29))).collect(Collectors.toList())).concat("\f").getBytes(Charsets.US_ASCII)});
		// Tests for adding/padding margins
		data.add(new Object[] {new GenericTextDocumentHandler.Builder().setLeftMargin(3).setTopMargin(2).build(), multiPageDocumentInput, Arrays.stream(multiPageDocumentOutputStrings).map(s -> String.format("\r\n\r\n   %s%s", s, "\f")).collect(StringBuilder::new, StringBuilder::append, StringBuilder::append).toString().getBytes(Charsets.US_ASCII)});
		// Multiple copy tests
		data.add(new Object[] {new GenericTextDocumentHandler.Builder().setCopies(2).build(), multiPageDocumentInput, Strings.repeat(Arrays.stream(multiPageDocumentOutputStrings).map(s -> s.concat("\f")).collect(StringBuilder::new, StringBuilder::append, StringBuilder::append).toString(), 2).getBytes(Charsets.US_ASCII)});
		data.add(new Object[] {new GenericTextDocumentHandler.Builder().setCopies(2).setLinesPerPage(30).build(), multiPageDocumentInput, Strings.repeat(Arrays.stream(multiPageDocumentOutputStrings).map(s -> s.concat("\f")).collect(StringBuilder::new, StringBuilder::append, StringBuilder::append).toString(), 2).getBytes(Charsets.US_ASCII)});
		data.add(new Object[] {new GenericTextDocumentHandler.Builder().setCopies(4).build(), multiPageDocumentInput, Strings.repeat(Arrays.stream(multiPageDocumentOutputStrings).map(s -> s.concat("\f")).collect(StringBuilder::new, StringBuilder::append, StringBuilder::append).toString(), 4).getBytes(Charsets.US_ASCII)});
		data.add(new Object[] {new GenericTextDocumentHandler.Builder().setCopies(3).setLinesPerPage(30).build(), multiPageDocumentInput, Strings.repeat(Arrays.stream(multiPageDocumentOutputStrings).map(s -> s.concat("\f")).collect(StringBuilder::new, StringBuilder::append, StringBuilder::append).toString(), 3).getBytes(Charsets.US_ASCII)});
		// Tests for adding/padding margins
		data.add(new Object[] {new GenericTextDocumentHandler.Builder().setCopies(11).setLeftMargin(3).setTopMargin(2).build(), multiPageDocumentInput, Strings.repeat(Arrays.stream(multiPageDocumentOutputStrings).map(s -> String.format("\r\n\r\n   %s%s", s, "\f")).collect(StringBuilder::new, StringBuilder::append, StringBuilder::append).toString(), 11).getBytes(Charsets.US_ASCII)});
