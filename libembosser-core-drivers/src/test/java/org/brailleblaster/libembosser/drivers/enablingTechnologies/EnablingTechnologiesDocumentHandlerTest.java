...
public class EnablingTechnologiesDocumentHandlerTest {
	...
	public Iterator<Object[]> handlerProvider() {
		...
		final String headerString = "\u001b@\u001bA@@\u001bK@\u001bW@\u001bi@\u001bs@\u001bL%s\u001bR%s\u001bQ%s";
		...
		data.add(new Object[] {createHandlerBuilder().build(), minimalDocumentInput, String.format(headerString, "@", "h", "Y") + "\f"});
		data.add(new Object[] {createHandlerBuilder().setLinesPerPage(30).build(), minimalDocumentInput, String.format(headerString, "@", "h", "^") + "\f"});
		data.add(new Object[] {createHandlerBuilder().setLinesPerPage(30).setTopMargin(2).build(), minimalDocumentInput, String.format(headerString, "@", "h", "`") + "\f"});
		data.add(new Object[] {createHandlerBuilder().setLeftMargin(2).build(), minimalDocumentInput, String.format(headerString, "B", "h", "Y") + "\f"});
		...
		data.add(new Object[] {createHandlerBuilder().build(), basicDocumentInput, String.format(headerString, "@", "h", "Y") + basicDocumentOutput});
		data.add(new Object[] {createHandlerBuilder().build(), basicCapsDocumentInput, String.format(headerString, "@", "h", "Y") + basicDocumentOutput});
		data.add(new Object[] {createHandlerBuilder().build(), basicUnicodeDocumentInput, String.format(headerString, "@", "h", "Y") + basicDocumentOutput});
		...
		data.add(new Object[] {createHandlerBuilder().build(), multiLineDocumentInput, String.format(headerString, "@", "h", "Y") + String.join("\r\n", multiLineDocumentOutputString).concat("\f")});
		...
		data.add(new Object[] {createHandlerBuilder().setCellsPerLine(35).build(), multiLineDocumentInput, String.format(headerString, "@", "c", "Y") + String.join("\r\n", multiLineDocumentOutputString).concat("\f")});
		data.add(new Object[] {createHandlerBuilder().setLinesPerPage(3).build(), multiLineDocumentInput, String.format(headerString, "@", "h", "C") + String.join("\r\n", multiLineDocumentOutputString).concat("\f")});
		// Confirm Braille is truncated to fit page limits.
		data.add(new Object[] {createHandlerBuilder().setLinesPerPage(2).build(), multiLineDocumentInput, String.format(headerString, "@", "h", "B") + String.join("\r\n", multiLineDocumentOutputString[0], multiLineDocumentOutputString[1]).concat("\f")});
		data.add(new Object[] {createHandlerBuilder().setCellsPerLine(6).build(), multiLineDocumentInput, String.format(headerString, "@", "F", "Y") + String.join("\r\n", Arrays.stream(multiLineDocumentOutputString).map(s -> s.substring(0, Math.min(s.length(), 6))).collect(Collectors.toUnmodifiableList())).concat("\f")});
		...
		data.add(new Object[] {createHandlerBuilder().build(), multiPageDocumentInput, String.format(headerString, "@", "h", "Y") + String.join("\f", multiPageDocumentOutputStrings).concat("\f")});
		...
		data.add(new Object[] {createHandlerBuilder().setLeftMargin(3).setTopMargin(2).build(), multiPageDocumentInput, String.format(headerString, "C", "h", "[") + Arrays.stream(multiPageDocumentOutputStrings).map(s -> String.format("\r\n\r\n%s\f", s)).collect(StringBuilder::new, StringBuilder::append, StringBuilder::append).toString()});
		// Multiple copy tests
		data.add(new Object[] {createHandlerBuilder().setCopies(2).build(), multiPageDocumentInput, String.format(headerString, "@", "h", "Y") + Strings.repeat(Arrays.stream(multiPageDocumentOutputStrings).map(s -> s.concat("\f")).collect(StringBuilder::new, StringBuilder::append, StringBuilder::append).toString(), 2)});
		...
		data.add(new Object[] {createHandlerBuilder().setCopies(4).build(), multiPageDocumentInput, String.format(headerString, "@", "h", "Y") + Strings.repeat(Arrays.stream(multiPageDocumentOutputStrings).map(s -> s.concat("\f")).collect(StringBuilder::new, StringBuilder::append, StringBuilder::append).toString(), 4)});
		...
		// Tests for adding/padding margins
		data.add(new Object[] {createHandlerBuilder().setCopies(11).setLeftMargin(3).setTopMargin(2).build(), multiPageDocumentInput, String.format(headerString, "C", "h", "[") + Strings.repeat(Arrays.stream(multiPageDocumentOutputStrings).map(s -> String.format("\r\n\r\n%s\f", s)).collect(StringBuilder::new, StringBuilder::append, StringBuilder::append).toString(), 11)});
