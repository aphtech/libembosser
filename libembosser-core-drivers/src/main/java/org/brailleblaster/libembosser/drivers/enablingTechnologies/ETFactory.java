...
public class ETFactory implements EmbosserFactory {
	...
	public ETFactory() {
		embossers = ImmutableList.<Embosser>builder()
				...
				.add(new GenericTextEmbosser("libembosser.et.phoenix_silver", "Phoenix  silver", TWELVE_BY_FOURTEEN_PAPER, ONE_AND_HALF_BY_THREE_PAPER, false))
				...
				.add(new GenericTextEmbosser("libembosser.et.trident", "Trident", TWELVE_BY_FOURTEEN_PAPER, ONE_AND_HALF_BY_THREE_PAPER, false))
				...
				.add(new GenericTextEmbosser("libembosser.et.juliet_classic", "Juliet Classic", FIFTEEN_BY_FOURTEEN_PAPER, ONE_AND_HALF_BY_THREE_PAPER, false))
				...
				.add(new GenericTextEmbosser("libembosser.et.juliet_pro", "Juliet Pro", FIFTEEN_BY_FOURTEEN_PAPER, ONE_AND_HALF_BY_THREE_PAPER, false))
				...
				.add(new GenericTextEmbosser("libembosser.et.juliet_pro60", "Juliet Pro60", FIFTEEN_BY_FOURTEEN_PAPER, ONE_AND_HALF_BY_THREE_PAPER, false))
				...
				.add(new GenericTextEmbosser("libembosser.et.romeo_pro50", "Romeo Pro50", THIRTEEN_AND_QUARTER_BY_FOURTEEN_PAPER, ONE_AND_HALF_BY_THREE_PAPER, false))
				...
				.add(new GenericTextEmbosser("libembosser.et.romeo_25", "Romeo25", THIRTEEN_AND_QUARTER_BY_FOURTEEN_PAPER, ONE_AND_HALF_BY_THREE_PAPER, false))
				.build();
	}
