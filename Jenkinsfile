		...
		stage('Build') {
			...
			post {
				always {
					...
					archiveArtifacts allowEmptyArchive: true, artifacts: "libembosser-utils/build/libs/*.jar,libembosser-core-drivers/build/libs/*.jar,libembosser-aph-driver/build/libs/*.jar,libembosser-braillo-driver/build/libs/*.jar,libembosser-viewplus-driver/build/libs/*.jar,libembosser-api/build/libs/*.jar"
				}
			}
		}
	}
